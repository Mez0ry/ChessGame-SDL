...
Piece::Piece(const Core::Ref<Renderer> renderer, const char* texture_path, PieceType piece_type) : m_IsKilled(true), m_ToMove(false), m_Position(-1,-1),m_PrevPos(-1,-1), m_PieceType(piece_type)
{
